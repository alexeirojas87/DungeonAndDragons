...
export const ITEM_TEMPLATES: Record<string, ItemTemplate> = {
  ...
  crypt_journal: {
    ...
    nameEs: 'Diario de la Expedición',
    type: 'quest',
    rarity: 'rare',
    weight: 1,
    value: 0,
    description: 'The journal of the last expedition into the Sunken Crypt, kept behind the council seal. Its final entry is unfinished.',
    descriptionEs: 'El diario de la última expedición a la Cripta Sumergida, guardado bajo el sello del consejo. Su última entrada está sin terminar.',
    properties: { special: ['A record of the last route into the crypt'] },
    usable: true,
    consumable: false,
  },
  bone_amulet: {
