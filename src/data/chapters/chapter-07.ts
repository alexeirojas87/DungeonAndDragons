...
const NODES: Record<string, StoryNode> = {
  ...
  c07_wall_gate: {
    ...
    text: 'The Naming Wall is not a wall of stone. It is a wall of names — every name the free witnesses carry, written on the salt-crusted stones, and each name is a defender.\n\nThe wall is half-built and the night is coming. The assembly gathers behind it, and the breach is open where the wall has not yet been raised.\n\nThree paths leave the gate: the walls where the lift is being built, the assembly where the creditors are being counted, and the breach where the Claim will come.',
  ...
  c07_assembly_call: {
    ...
    text: 'The assembly is the gathering of every ally this campaign has carried — the free witnesses, the fleet eye, the salt caravan, the wood keepers, and the ones who came with you from the first road. They stand behind the half-built wall and they wait for someone to carry the standard.\n\n"The Claim is the ram," the assembly says with one voice, "and the wall is the names. Choose who carries the standard, and the wall will follow."',
  ...
  c07_wall_witness: {
    ...
    text: 'The wall-witness is one of the free witnesses, her name carved in the base of the wall. "I am the wall," she says. "My name is the base. Lift the base first, then the gate, then the crest. The wall follows the names, and the names follow the order."\n\nShe touches the stone. "Lift them wrong and my name cracks. Lift them right and my name holds the night."',
  ...
  c07_death_gate: {
    ...
    text: 'The death gate is the room where one price can be paid. Elara or Varen — whichever bond is highest — can walk the room and pay the price the wall cannot: a life for a name, a name for a wall. If one walks, the wall holds the night and the bond ends. If neither walks, the watchman lives — but the wall must hold on its own.\n\n"Choose," the assembly says. "The night does not wait for the living."',
  ...
  c07_final_choice: {
    ...
    text: 'The night is here and the death gate is settled. The wall stands or it does not, the Claim is broken or it is not, and the allies are gathered or they are not.\n\nFour outcomes close the siege: the wall holds, the wall wins, the wall breaks, or the wall is riven — split between the names that held and the names that did not.\n\n"Choose," the assembly says. "The morning will count what the night leaves."',
