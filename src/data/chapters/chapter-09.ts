...
const NODES: Record<string, StoryNode> = {
  c09_arrival: {
    ...
    text: 'The road home edges past a Blackmere that has grown over the door. The village has crept down to the crypt since you left it — new walls, new lanterns, a choir that sings where the council once kept silent.\n\nEvery choice of the first chapter returns here: the door you left sealed or open, named or nameless, the relic kept or taken. The Black Lantern still stands at the crossroads, and Martik is still behind its bar. The last collector has not knocked yet, but the road knows he is coming.',
    textEs: 'El camino de regreso bordea un Blackmere que ha crecido sobre la puerta. El pueblo se ha arrimado a la cripta desde que lo dejaste — muros nuevos, faroles nuevos, un coro que canta donde el consejo antes guardaba silencio.\n\nCada elección del primer capítulo vuelve aquí: la puerta que dejaste sellada o abierta, con nombre o sin él, la reliquia conservada o perdida. El Farol Negro sigue en el cruce, y Martik sigue detrás de su barra. El último cobrador aún no ha llamado, pero el camino sabe que viene.',
    choices: [
  ...
  c09_first_edge: {
    ...
    text: 'The door has grown into the hill, and someone must speak to it before it will answer. Three voices can speak at the door: the one who owes the most — Martik, who kept the first silence; the one with the most to give — Varen, who guided every road; or you alone, who have carried every name this campaign traded.\n\n"Choose," the choir sings from the wall. "The door only listens once."',
    textEs: 'La puerta ha crecido hacia el cerro, y alguien debe hablarle antes de que responda. Tres voces pueden hablar en la puerta: la que más debe — Martik, que guardó el primer silencio; la que más tiene que dar — Varen, que guió cada camino; o tú solo, que has llevado cada nombre que esta campaña trocó.\n\n—Elige —canta el coro desde el muro—. La puerta solo escucha una vez.',
    choices: [
  ...
  c09_owes_lane: {
    ...
    textEs: 'Martik te lleva primero al Farol Negro. —Guardé el silencio del consejo cuando la puerta respiró por primera vez —dice—. Le debo a la puerta la verdad de ese silencio, y puedo pagarlo sin un golpe. Siéntate, y deja que yo hable el precio honesto. El farol está caliente y el camino está frío, y Martik ha guardado la posada toda la campaña.',
    choices: [
  ...
  c09_martik_price: {
    ...
    text: 'Martik speaks the honest price: the council paid the door to stay silent, and the door kept the names the council could not. The debt is not the door — it is the village, and Martik names it in the warm room where the council once hid it.\n\nNo steel is drawn. The talk closes the debt, and the door hears its own name spoken for the first time since you left it. Martik walks you down to the yard.',
    textEs: 'Martik habla el precio honesto: el consejo pagó a la puerta para que guardara silencio, y la puerta guardó los nombres que el consejo no pudo. La deuda no es de la puerta — es del pueblo, y Martik la nombra en la sala caliente donde el consejo antes la escondía.\n\nNo se desenvaina acero. La charla cierra la deuda, y la puerta oye su propio nombre pronunciado por primera vez desde que la dejaste. Martik te lleva al patio.',
    choices: [
  ...
  c09_collector_bargain: {
    ...
    text: 'The collector lays the tally open: every name the campaign traded, every door it crossed, every price it paid or kept. The door closes on the tally one way — open, sealed, burned, or carried by the one who walks the threshold for the rest.\n\nIf the Veiled Court vindicated the door, you can press its verdict on the collector and seal the door with the court hand. Choose the way the door closes.',
    textEs: 'El cobrador abre la suma: cada nombre que la campaña trocó, cada puerta que cruzó, cada precio que pagó o guardó. La puerta se cierra sobre la suma de una forma — abierta, sellada, quemada, o cargada por quien camine el umbral el resto del tiempo.\n\nSi la Corte del Velo vindicó la puerta, puedes imponer su veredicto al cobrador y sellar la puerta con la mano de la corte. Elige la forma en que la puerta se cierra.',
    choices: [
